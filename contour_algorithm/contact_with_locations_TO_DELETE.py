...
def set_outside_to_0():
    ...
    df.to_csv(f'C:/Users/mehes/Documents/repo/Thesis R part/Temp-11-11/locations_new.csv', index=False)
...
def main():
    ...
    #set_outside_to_0() """I think we dont need it for standardization"""
