...
image <- t(as.matrix(load.image(paste(ROOT_PATH, "statistical_model/dataset/new_contour_135.png", sep = ""))))
...
Random<-function(nknotsx=3,nknotsy=5,dat=dataCC,model_feat = MODEL_FEATURE, initial_values )
{
  ...
  cat("file_saving")
  file_name <- paste(ROOT_PATH, "statistical_model/saved_models/",MODEL_FEATURE,"_RELATIVE.rds", sep = "")
