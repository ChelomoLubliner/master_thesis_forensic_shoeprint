...
# Naive is already on the marginal scale — no rescaling needed
...
pdf(file = paste(ROOT_PATH, "statistical_model/model_images/pixel_intense_no_Naive.pdf", sep = ""), height=8, width=8)
