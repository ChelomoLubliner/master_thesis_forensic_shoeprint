...
```{r }
ROOT_PATH = 'C:/Users/mehes/Documents/repo/master_thesis_forensic_shoeprint/'
...
```{r }
file_name <- paste(ROOT_PATH,"statistical_model/dataset/dataCC_distance_part4.csv", sep = "")
...
file_name <- paste(ROOT_PATH, "statistical_model/model_images/NEW_X_NS_XY_",IMAGE_NUMBER, "_NEW_SHOE.pdf", sep = "")
pdf(file = file_name, height = 6, width = 6)
image.plot(im_rotated, axes = TRUE)
abline(v = 0.5, col = "black", lty = 1, lwd = 1)
abline(h = 0.5, col = "black", lty = 1, lwd = 1)
...
new_rotated <- old_matrix
im_rotated <- t(new_rotated)[, nrow(new_rotated):1]
file_name <- paste(ROOT_PATH, "statistical_model/model_images/NEW_X_NS_XY_",IMAGE_NUMBER, "_NEW_CONTOUR.pdf", sep = "")
pdf(file = file_name, height = 6, width = 6)
image.plot(im_rotated, axes = TRUE)
abline(v = 0.5, col = "black", lty = 1, lwd = 1)
abline(h = 0.5, col = "black", lty = 1, lwd = 1)
