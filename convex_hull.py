...
def get_convex_plotly(points, im_num):
    ...
    final_img.save(f'{PATH}{FOLDER}Convex_Hull/im_{im_num}.png')
...
def get_convex_plotly_html(points, im_num):
    ...
    pyo.plot(fig, filename=f'{PATH}{FOLDER}Convex_Hull_html/plot_cont_{im_num}.html',auto_open=False)
...
def main():
    ...
    np.save(f'{PATH}{FOLDER}Saved/convex_all.npy', convex_all)
